...
(function($) {
    ...
    var $allContentDivs = $('#sampul-konten, #mempelai-konten, #hadir-konten, #acara-konten, #album-konten, #ucapan-konten, #lokasi-konten, #cerita-konten, #prokes-konten, #hadiah-konten').hide(); // Hide All Content Divs
    ...
    $('#sampul, #mempelai, #acara, #album, #ucapan, #hadir, #lokasi, #cerita, #prokes, #hadiah').click(function(){
    ...
    var date_syukuran = moment(new Date(tanggal_syukuran)).format('dddd, Do MMMM YYYY'); 

    //output = 17 / 08 / 2020
    var date_pernikahan = moment(new Date(tanggal_resepsi)).format('DD / MM / YYYY'); //untuk sampul
